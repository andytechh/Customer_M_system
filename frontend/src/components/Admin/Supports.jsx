...
const AdminChat = () => {
  ...
  const sendAdminMessage = async () => {
    ...
    try {
      ...
      setInput('');
      fetchMessages(receiver_id); // Refresh
    } catch (err) {
  ...
  return (
    <div className="flex h-[700px] max-w-6xl mx-auto border shadow-lg bg-white mt-8 font-sans overflow-hidden">
      
      {/* Customer List - Scrollable */}
      <div className="w-72 border-r bg-gray-100 p-4 flex flex-col">
